...
namespace UniCoil {
    ...
    void Launcher::Draw()
    {
        ...
        if (!ImGui::Begin("AyPz Tool", (bool*)&g_Running, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_AlwaysAutoResize)) {
            ImGui::PopStyleColor();
            ImGui::PopStyleColor();
            ImGui::PopStyleColor();
            ImGui::End();
    ...
    void Launcher::Menu()
    {
        ...
        if (g_Profile->selectedPRESET == NULL) {
            ...
            //  Inclure la méthode pour montrer à l'utilisateur ses préréglagesC
    ...
    void Launcher::InitStyle()
    {
        ...
        style.GrabRounding = style.FrameRounding; // Faites en sorte que GrabRounding est toujours la même valeur que FrameRounding
